...
export declare function multisig(m: number, pubkeys: Bytes[], sorted?: boolean, witness?: boolean, network?: {
    bech32: string;
    pubKeyHash: number;
    scriptHash: number;
    wif: number;
}): P2Ret;
export declare function sortedMultisig(m: number, pubkeys: Bytes[], witness?: boolean, network?: {
    bech32: string;
    pubKeyHash: number;
    scriptHash: number;
    wif: number;
