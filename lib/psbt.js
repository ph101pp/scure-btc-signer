...
// prettier-ignore
exports.PSBTGlobal = {
    unsignedTx: [0x00, false, script_js_2.RawOldTx, [0], [0], false],
...
// prettier-ignore
exports.PSBTInput = {
    nonWitnessUtxo: [0x00, false, script_js_2.RawTx, [], [0, 2], false],
    witnessUtxo: [0x01, false, script_js_2.RawOutput, [], [0, 2], false],
    ...
    finalScriptWitness: [0x08, false, script_js_2.RawWitness, [], [0, 2], false],
...
exports.PSBTInputCoder = P.validate(PSBTKeyMap(exports.PSBTInput), (i) => {
    ...
    if (i.nonWitnessUtxo && i.index !== undefined && i.txid) {
        ...
        const tx = transaction_js_1.Transaction.fromRaw(script_js_2.RawTx.encode(i.nonWitnessUtxo), {
